...
# SPSR in the paper (x2)
#python main.py --model EMSRPLUS --scale 2 --save EMSRPLUS_x2 --n_resblocks 32 --n_feats 256 --res_scale 0.1  --ext sep --data_train DIV2K --data_test DIV2K  --epochs 350
#python main.py --model EMSR --scale 2 --save EMSR1000_x2 --n_resblocks 32 --n_feats 256 --res_scale 0.1  --ext sep --data_train DIV2K --data_test DIV2K --pre_train ../experiment/EMSR1000_x2/model/model_latest.pt --epochs 600
# SPSR in the paper (x3) - from SPSR (x3)
#python main.py --model EDSR --scale 2 --save edsr_x2 --n_resblocks 32 --n_feats 256 --res_scale 0.1  --ext sep --data_train DIV2K --data_test DIV2K

# SPSR in the paper (x4) - from SPSR (x4)
#python main.py --model SPSR --scale 4 --save spsr_x4 --n_resblocks 32 --n_feats 256 --res_scale 0.1  --ext sep --data_train ULTRASOUND --data_test ULTRASOUND --pre_train ../experiment/spsr_x4/model/model_latest.pt
...
python main.py --model EMSRPLUS --n_resblocks 32 --n_feats 256 --data_test Set5+Set14+B100+Urban100+DIV2K --data_range 801-900 --scale 2 --pre_train ../experiment/EMSRPLUS_x2/model/model_latest.pt --test_only  --save_results
